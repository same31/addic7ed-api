...
function findSubtitles (body, languages) {
    var subs          = [],
        ...
        serieName     = titleMatch ? titleMatch[1].trim() : '',
    ...
    var serieNameAndEspisodeNameMatch = /class="titulo">(.*)-.*- (.*) <small>/gs.exec(body);
    var serieName = serieNameAndEspisodeNameMatch[1].trim();
    var episodeName = serieNameAndEspisodeNameMatch[2];
