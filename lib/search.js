    ...
    return request({
        ...
        while ((versionMatch = versionRegExp.exec(body)) !== null) {
            ...
            while ((subInfoMatch = subInfoRegExp.exec(versionMatch[2])) !== null) {
                ...
                distributionMatch = version.match(/WEB.DL|WEB.?RIP|WR|BRRIP|BDRIP|BLURAY/i);
                ...
                team = version.replace(/.?(REPACK|PROPER|X264|HDTV|480P|720P|1080P|2160P|WEB.DL|WEB.?RIP|WR|BRRIP|BDRIP|BLURAY)+.?/g, '')
                    .trim().toUpperCase();
